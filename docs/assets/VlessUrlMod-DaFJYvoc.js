import{h as w,i as T,j as f,k as m,l as B,d as $,m as y,n as S,p as J,q as F,s as Q,v as X,x as Y,y as Z,z as ee,A as te,B as z,c as N,C as M,D as oe,E,F as re,G as ne,H as se,I as le,a as j,b as R,o as V,J as k,f as i,w as d,u,K as C,g as v,r as ae}from"./index-CjCmZfvA.js";import{N as _}from"./Input-B8IVPq-t.js";function ie(e,t="default",o=[]){const a=e.$slots[t];return a===void 0?o:a()}const l="0!important",A="-1px!important";function b(e){return f(`${e}-type`,[m("& +",[w("button",{},[f(`${e}-type`,[B("border",{borderLeftWidth:l}),B("state-border",{left:A})])])])])}function x(e){return f(`${e}-type`,[m("& +",[w("button",[f(`${e}-type`,[B("border",{borderTopWidth:l}),B("state-border",{top:A})])])])])}const de=w("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
